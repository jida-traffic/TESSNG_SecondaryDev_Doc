...
class MyPlugin(TessPlugin):
    ...
    def initGui(self):
        ...
        action_setTrafficCanalizationOpt = menu_process_control.addAction("修改交叉口渠化")
        action_setTrafficCanalizationOpt.setCheckable(False)
        action_setTrafficCanalizationOpt.triggered.connect(self.examleWindow.set_traffic_canalization)

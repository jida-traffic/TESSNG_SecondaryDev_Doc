...
from DLLs.Tessng import TessInterface, TessPlugin, NetInterface, PyCustomerNet
from DLLs.Tessng import tessngPlugin, tessngIFace, m2p, p2m
...
class MyNet(PyCustomerNet):
    ...
    def createNet(self):
        ...
        link1 = netiface.createLink(lPoint, 4, "双龙大道")
    ...
    def paint(self, itemType: int, itemId: int, painter):
        ...
        if not self.text:
            ...
            failedItem = QGraphicsTextItem("车辆在场景中央抛锚")
            x, y = -200, 20
            ...
            line = QGraphicsLineItem(-500, 100, -500, -100)  # 参数是起点和终点的坐标
            scene.addItem(line)
